const C='crossscan-beta45-offline-v1';
const A=['./','./index.html','./manifest.webmanifest','./vendor/zxing-browser.min.js','./vendor/xlsx.full.min.js','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
